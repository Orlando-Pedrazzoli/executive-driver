...
const values = [
  {
    ...
    title: 'Segurança',
    description:
      'Direção defensiva e veículos sempre revisados para sua proteção',
  },
  {
    icon: Clock,
    title: 'Pontualidade',
    ...
    <div className='min-h-screen bg-white pt-20'>
      ...
      <section className='relative py-20 bg-gradient-to-br from-primary via-primary-600 to-primary-800 overflow-hidden'>
        ...
        <div className='container mx-auto px-4 relative z-10'>
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
            ...
            >
              <h1 className='text-5xl font-bold text-white mb-6'>Sobre Mim</h1>
              <h2 className='text-3xl text-secondary mb-4'>
                Maria Fernanda Silva
              </h2>
              <p className='text-xl text-gray-200 mb-6 leading-relaxed'>
                Olá! Sou Maria Fernanda, sua motorista executiva de confiança.
                Com mais de 10 anos de experiência no transporte premium, meu
                compromisso é transformar cada viagem em uma experiência segura,
                confortável e memorável.
              </p>
              <p className='text-lg text-gray-300 mb-8'>
                Especializada em atendimento corporativo e transfers
                aeroportuários, ofereço um serviço personalizado que vai além do
                transporte – é sobre cuidar de cada detalhe para que você possa
        ...
        <div className='container mx-auto px-4'>
          ...
          >
            ...
            <p className='text-gray-600 max-w-2xl mx-auto'>
              Princípios que guiam cada viagem e definem a excelência do meu
              serviço
            </p>
          </motion.div>
              ...
              {[
                {
                  ...
                  description:
                    'Comecei como motorista particular, descobrindo minha paixão por proporcionar experiências excepcionais.',
                },
                {
                  year: '2016',
                  title: 'Especialização Executiva',
                  description:
                    'Foquei no segmento executivo, atendendo empresários e executivos com necessidades específicas.',
                },
                {
                  year: '2018',
                  title: 'Expansão dos Serviços',
                  description:
                    'Ampliei para transfers aeroportuários e eventos especiais, sempre mantendo o padrão premium.',
                },
                {
                  year: '2020',
                  title: 'Certificações e Treinamentos',
                  description:
                    'Investi em cursos de direção defensiva, primeiros socorros e atendimento VIP.',
                },
                {
                  year: '2024',
                  title: 'Elite Driver',
                  description:
                    'Consolidei minha marca pessoal como referência em transporte executivo de luxo.',
                },
              ].map((item, index) => (
                <motion.div
                  key={index}
      ...
      <section ref={ref3} className='py-20 bg-gray-50'>
        <div className='container mx-auto px-4'>
          ...
          >
            ...
            <p className='text-gray-600 max-w-2xl mx-auto'>
              Investimento contínuo em conhecimento para oferecer o melhor
              serviço
            </p>
          </motion.div>
      ...
      <section className='py-20 bg-gradient-to-r from-primary to-primary-700 text-white'>
        <div className='container mx-auto px-4 text-center'>
          <h2 className='text-4xl font-bold mb-4'>Vamos Viajar Juntos?</h2>
