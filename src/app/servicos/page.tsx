...
const services = [
  {
    ...
    description:
      'Transporte premium para todos os aeroportos com conforto e pontualidade',
    image:
  ...
  },
  {
    ...
    description:
      'Transporte elegante para casamentos, formaturas e eventos corporativos',
    image:
  ...
  },
  {
    ...
    image:
      'https://images.unsplash.com/photo-1563720360172-67b8f3dce741?q=80&w=2070',
    icon: Calendar,
    features: [
      'Motorista exclusiva',
  ...
  },
  {
    ...
    image:
      'https://images.unsplash.com/photo-1494783367193-149034c05e8f?q=80&w=2070',
    icon: MapPin,
    features: [
      'Rotas planejadas',
      'Paradas programadas',
...
const vehicleFleet = [
  {
    ...
    image:
      'https://images.unsplash.com/photo-1550355291-bbee04a92027?q=80&w=2072',
  },
  {
    category: 'Luxo',
  ...
  },
  {
    ...
    image:
      'https://images.unsplash.com/photo-1519641766308-9330af4854bb?q=80&w=2071',
  },
];
        ...
        <div className='container mx-auto px-4 relative z-10'>
          ...
          >
            ...
            <p className='text-xl text-gray-200 mb-8'>
              Soluções completas de transporte executivo para todas as suas
              necessidades. Escolha o serviço ideal para sua viagem.
            </p>
        ...
        <div className='container mx-auto px-4'>
          ...
          >
            ...
            <p className='text-gray-600 max-w-2xl mx-auto'>
              Veículos novos, sempre revisados e higienizados para sua segurança
              e conforto
            </p>
          </motion.div>
      ...
      >
        <div className='container mx-auto px-4'>
          ...
          >
            ...
            <p className='text-gray-600 max-w-2xl mx-auto'>
              Todos os nossos serviços incluem benefícios exclusivos sem custo
              adicional
            </p>
          </motion.div>
      ...
      <section className='py-20 bg-primary text-white'>
        <div className='container mx-auto px-4 text-center'>
          ...
          <p className='text-xl text-gray-200 mb-8 max-w-2xl mx-auto'>
            Escolha o serviço ideal para sua necessidade e viaje com a
