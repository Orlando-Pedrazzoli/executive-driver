...
import { 
  Star, Shield, Clock, Award, Users, Car, MapPin, 
  Calendar, ChevronRight, Quote, CheckCircle, Phone,
  CreditCard, Briefcase, Plane, Building
} from 'lucide-react'
...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen">
          ...
          <div className="max-w-3xl">
            ...
            >
              ...
              <p className="text-xl text-gray-200 leading-relaxed">
                Transforme suas viagens em experiências excepcionais. 
                Serviço personalizado de transporte executivo com pontualidade, 
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Soluções completas de transporte executivo adaptadas às suas necessidades
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                description: "Transporte VIP para todos os aeroportos com pontualidade garantida",
                features: ["Monitoramento de voo", "Recepção personalizada", "Auxílio com bagagem"]
              },
              {
                icon: Building,
                title: "Corporativo",
                description: "Serviço exclusivo para executivos e empresas",
                features: ["Motorista fixo", "Relatórios mensais", "Faturamento empresarial"]
              },
              {
                icon: Calendar,
                title: "Eventos Especiais",
                description: "Transporte premium para eventos e ocasiões especiais",
                features: ["Decoração personalizada", "Roteiro flexível", "Champagne de cortesia"]
              }
            ].map((service, index) => (
              <motion.div
                key={index}
      ...
      {/* Reviews Section */}
      <section ref={ref2} className="py-20 bg-gradient-to-br from-gray-50 to-white">
        <div className="container mx-auto px-4">
          <motion.div
            initial={{ opacity: 0 }}
            ...
            {[
              {
                ...
                rating: 5,
                comment: "Serviço impecável! A pontualidade e profissionalismo são incomparáveis. Recomendo para todos os executivos que precisam de um transporte confiável."
              },
              {
                ...
                rating: 5,
                comment: "Uso o serviço há 2 anos para minhas viagens corporativas. Sempre pontual, veículo impecável e a motorista é extremamente profissional."
              },
              {
                ...
                rating: 5,
                comment: "Excelente para transfers de aeroporto. A motorista monitora os voos e está sempre esperando, mesmo quando há atrasos. Serviço premium de verdade!"
              }
            ].map((review, index) => (
              <motion.div
                key={index}
            ...
            {[
              {
                ...
                description: "Veículos revisados, seguro completo e motorista treinada"
              },
              {
                icon: Clock,
                title: "Pontualidade",
                description: "Sempre no horário, com planejamento de rotas inteligente"
              },
              {
                icon: Award,
      ...
      <section className="py-20 bg-gradient-to-r from-secondary to-secondary-600">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-primary/80 text-xl mb-8 max-w-2xl mx-auto">
            Agende sua viagem agora e descubra o verdadeiro significado de transporte executivo
          </p>
