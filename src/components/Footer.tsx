...
import { Car, MapPin, Phone, Mail, Shield, Award, Clock, CreditCard } from 'lucide-react'
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h3 className="font-bold text-xl">Elite Driver</h3>
                <p className="text-xs text-gray-300">Excelência em Transporte</p>
              </div>
            </div>
            <p className="text-gray-300 leading-relaxed">
              Serviço premium de motorista executiva com segurança, 
              conforto e pontualidade para suas viagens corporativas e pessoais.
            </p>
          ...
          {/* Quick Links */}
          <div className="space-y-4">
            <h4 className="font-semibold text-lg text-secondary">Links Rápidos</h4>
          ...
          {/* Services */}
          <div className="space-y-4">
            <h4 className="font-semibold text-lg text-secondary">Nossos Serviços</h4>
          ...
          <div className="space-y-4">
            <h4 className="font-semibold text-lg text-secondary">Contato & Segurança</h4>
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm">
            ...
            <div className="flex gap-6">
              <Link href="/privacidade" className="text-gray-300 hover:text-secondary transition-colors">
                Política de Privacidade
              </Link>
              <Link href="/termos" className="text-gray-300 hover:text-secondary transition-colors">
                Termos de Uso
              </Link>
              <Link href="/lgpd" className="text-gray-300 hover:text-secondary transition-colors">
                LGPD
              </Link>
            </div>
          </div>
